...
<head>
    ...
    <meta name="facebook-domain-verification" content="0g1t70eiwkdcljuo64bvplb4d4ntlh" />
</head>
...
<div class="svg_icons">
    ...
    <svg id="icon-svg-like" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M21.6703 1.43593C19.1016 -0.753131 15.2812 -0.359381 12.9234 2.07343L12 3.02499L11.0766 2.07343C8.72343 -0.359381 4.89843 -0.753131 2.32968 1.43593C-0.614067 3.94843 -0.768755 8.45781 1.86562 11.1812L10.9359 20.5469C11.5219 21.1516 12.4734 21.1516 13.0594 20.5469L22.1297 11.1812C24.7687 8.45781 24.6141 3.94843 21.6703 1.43593Z"
              style="fill: var(--icon-color, black)"/>
    </svg>
