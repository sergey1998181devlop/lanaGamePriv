@extends('layouts.app')
@section('page')
    <title>Всё про компьютерные клубы на сайте LANGAME.RU</title>
    <meta name="description"
          content="Платформа для владельцев, управляющих и гостей кибер-арен, гейм-лаунжей и киберспортивных клубов. Развиваем бизнес и культуру компьютерных клубов!">
    <meta name="keywords" content="компьютерные клубы, бизнес, агрегатор,  лангейм, langame"/>
@endsection
@section('content')
                ...
                <div class="description_item">
                    ...
                    <ul class="description_list">
                        ...
                        <li>
                            ...
                            <div class="descr">
                                Доверительное управление, бугхалтерия, удалённый администратор, замена жестких дисков на серверное решение и другие услуги.
