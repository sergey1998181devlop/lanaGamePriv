        ...
        <div class="container">
            ...
            <div class="club_list_content_tabs">
                ...
                <div class="tab" id="tab5" style="display: none">
                    <div class="club_list_content">
                        <div class="company_offers_wrapper">
                            <button type="button" class="add_offer">Добавить объявление</button>
                            <div class="attention_text_wrapper">
                                ...
                                <div class="instr">
                                    ...
                                    <p>
                                        <span class="text-decor">Администрация langame.ru не имеет отношения</span> к содержанию объявлений, а просто предоставляет площадку для них.
                                    </p>
                                    <p>
        ...
        <div class="remodal-content">
            ...
            <div class="offer_content_wrapper">
                <div class="offer_content_item">
                    ...
                    <button type="button" class="offer_btn">Показать контакт</button>
                </div>
                <div class="offer_content_item">
