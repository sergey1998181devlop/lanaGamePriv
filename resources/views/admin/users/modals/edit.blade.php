  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{__('messages.editUserHeader')}}</h5>
      ...
      <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror @error('password_confirmation') is-invalid @enderror " name="password" autocomplete="new-password">
