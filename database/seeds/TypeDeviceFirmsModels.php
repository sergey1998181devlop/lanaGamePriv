...
class TypeDeviceFirmsModels extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $data = [
            ...
            'videoCards'    =>  [
                ...
                'AMD' => [
                    ...
                    'Radeon RX 5700 8 Gb',
                    'Radeon RX Vega 64 Liquid Cooling 8 Gb',
                    'Radeon RX Vega 64 8 Gb',
                    'IA GeForce GTX 1070 Ti 8 Gb',
                    'Radeon RX 5600 XT 6 Gb',
                    'Radeon Vega Frontier Edition 16 Gb',
        ...
        foreach ($data as $typeDevice => $device){
